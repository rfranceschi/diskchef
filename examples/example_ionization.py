...
radmc = diskchef.maps.RadMCThermMono(
    ...
    external_source_type="Draine1978"
)
radmc.create_files()
radmc.run(threads=8)
...
diskchef.engine.plot.Plot2D(full_chemistry.table, axes=ax[1, 2], data1="Radiation strength",
                            data2="Radiation strength", cmap="plasma", maxdepth=1e12)
